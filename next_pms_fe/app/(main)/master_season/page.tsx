...
const Page = () => {
    ...
    const [dataRekap, setDataRekap] = useState<DataRekap>({
        ...
        show: false,
        adjust: false,
        fileName: `laporan-master-season-${new Date().toISOString().slice(0, 10)}`,
        judul1: 'Laporan Master Season',
        judul2: ''
    });
    ...
    const formik = useFormik<initValue>({
        ...
        validate: (data: initValue) => {
            ...
            if (!data.nama_musim || !data.nama_musim.trim()) errors.nama_musim = 'Nama Season wajib diisi.';
            return errors;
        },
        onSubmit: (data) => {
