...
import { formatDateSystem, formatTimeStringToDate } from '@/lib/tools/dateTools';
...
const Table = ({ dataRekap, setDataRekap, state, setState, formik, toast, getData, getPrintData, onLazyLoad }: TableProps) => {
    ...
    const headerTemplate = (
        <div className="flex flex-wrap align-items-center justify-content-between gap-2">
            <span className="text-xl font-bold">Daftar Properti Cabang</span>
                ...
                <span className="p-input-icon-left w-full md:w-20rem">
                    <IconField iconPosition="left">
                        ...
                        <InputText
                            ...
                            className="w-full"
                            placeholder="Cari Cabang, Kode, Alamat, NPWP..."
                            onChange={(e) => {
    ...
    const actionBodyTemplate = (rowData: TableData) => (
        <div className="flex justify-content-center gap-2">
            <Button
                ...
                onClick={() => {
                    const checkInDate = formatTimeStringToDate(rowData.check_in_time);
                    const checkOutDate = formatTimeStringToDate(rowData.check_out_time);
                    ...
                    formik.setValues({
                        ...
                        check_in_time: checkInDate || rowData.check_in_time,
                        check_out_time: checkOutDate || rowData.check_out_time,
                        timezone: rowData.timezone || 'Asia/Jakarta',
                        is_pkp: rowData.is_pkp !== undefined ? rowData.is_pkp : 0,
    ...
    const pkpStatusBodyTemplate = (rowData: TableData) => (
        <Tag
            value={rowData.is_pkp === 1 ? 'PKP' : 'Non-PKP'}
            severity={rowData.is_pkp === 1 ? 'info' : 'warning'}
        />
    );
        ...
        <>
            <div className="card">
                <div className="flex justify-content-between align-items-start mb-4">
                    <div className="flex flex-column">
                        <h3 className="text-2xl font-semibold flex align-items-center gap-2">
                            <i className="pi pi-building text-blue-600 text-3xl"></i>Master Cabang
                        </h3>
                        <p className="text-gray-500">Kelola informasi properti cabang, alamat, NPWP, jam operasional check-in/out, mata uang, dan status perpajakan.</p>
                    </div>
                </div>
                ...
                <DataTable
                    ...
                    currentPageReportTemplate="Menampilkan {first} - {last} dari {totalRecords} data cabang"
                >
                    ...
                    <Column field="kode_cabang" header="Kode" align="center" sortable style={{ minWidth: '10rem' }}></Column>
                    <Column field="name" header="Nama Cabang" sortable style={{ minWidth: '16rem' }}></Column>
                    <Column field="address" header="Alamat" style={{ minWidth: '18rem' }} body={(rowData) => rowData.address || '-'}></Column>
                    <Column field="telepon" header="Telepon" style={{ minWidth: '10rem' }} body={(rowData) => rowData.telepon || '-'}></Column>
                    <Column field="check_in_time" header="Check-In" align="center" style={{ minWidth: '8rem' }}></Column>
                    <Column field="check_out_time" header="Check-Out" align="center" style={{ minWidth: '8rem' }}></Column>
                    <Column field="timezone" header="Zona Waktu" align="center" style={{ minWidth: '10rem' }}></Column>
