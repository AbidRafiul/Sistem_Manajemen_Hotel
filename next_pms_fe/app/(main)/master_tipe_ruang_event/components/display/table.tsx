...
const Table = ({ dataRekap, setDataRekap, state, setState, formik, toast, getData, getPrintData, onLazyLoad }: TableProps) => {
    ...
    const headerTemplate = (
        <div className="flex flex-wrap align-items-center justify-content-between gap-2">
            <span className="text-xl font-bold">Daftar Tipe Ruang Event</span>
                ...
                <span className="p-input-icon-left w-full md:w-20rem">
                    <IconField iconPosition="left">
                        ...
                        <InputText
                            ...
                            className="w-full"
                            placeholder="Cari Tipe Ruang Event..."
                            onChange={(e) => {
    ...
    const actionBodyTemplate = (rowData: TableData) => (
        <div className="flex justify-content-center gap-2">
            ...
            <Button
                ...
                tooltip="Hapus Tipe Ruang Event"
            />
        </div>
    );
        ...
        <>
            <div className="card">
                <div className="flex justify-content-between items-start mb-6">
                    <div className="flex flex-column">
                        <h3 className="text-2xl font-semibold flex align-items-center gap-2">
                            <i className="pi pi-building text-blue-600 text-3xl"></i>Master Tipe Ruang Event
                        </h3>
                        <p className="text-gray-500">Kelola kategori tipe ruang event (Ballroom, Meeting Room, dll).</p>
                    </div>
                </div>
                ...
                <DataTable
                    ...
                    dataKey="kode_tipe_ruang_event"
                    emptyMessage="Tidak ada data tipe ruang event"
                    rowsPerPageOptions={[5, 10, 25, 50, 100]}
                    paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown"
                    currentPageReportTemplate="Menampilkan {first} - {last} dari {totalRecords} data tipe ruang event"
                >
                    <Column selectionMode="multiple" headerStyle={{ width: '3rem' }} />
                    <Column field="kode_tipe_ruang_event" header="Kode" align="center" sortable style={{ minWidth: '10rem' }}></Column>
                    <Column field="nama_tipe" header="Nama Tipe Ruang Event" sortable style={{ minWidth: '18rem' }}></Column>
