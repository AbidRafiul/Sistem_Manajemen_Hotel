...
const Page = () => {
    ...
    const [dataRekap, setDataRekap] = useState<DataRekap>({
        ...
        show: false,
        adjust: false,
        fileName: `laporan-master-tipe-ruang-event-${new Date().toISOString().slice(0, 10)}`,
        judul1: 'Laporan Master Tipe Ruang Event',
        judul2: ''
    });
    ...
    const formik = useFormik<initValue>({
        ...
        validate: (data: initValue) => {
            ...
            if (!data.nama_tipe || !data.nama_tipe.trim()) errors.nama_tipe = 'Nama Tipe Ruang Event wajib diisi.';
            return errors;
        },
        onSubmit: (data) => {
