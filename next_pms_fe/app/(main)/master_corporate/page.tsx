...
const Page = () => {
    ...
    const [dataRekap, setDataRekap] = useState<DataRekap>({
        ...
        show: false,
        adjust: false,
        fileName: `laporan-master-corporate-${new Date().toISOString().slice(0, 10)}`,
        judul1: 'Laporan Master Corporate / Travel Agent',
        judul2: ''
    });
    ...
    const formik = useFormik<initValue>({
        ...
        validate: (data: initValue) => {
            ...
            if (!data.account_type) {
                errors.account_type = 'Tipe Akun wajib diisi.';
            }
            return errors;
        },
        onSubmit: (data) => {
