...
const Table = ({ dataRekap, setDataRekap, state, setState, formik, toast, getData, getPrintData, onLazyLoad }: TableProps) => {
    ...
    const headerTemplate = (
        <div className="flex flex-wrap align-items-center justify-content-between gap-2">
            <span className="text-xl font-bold">Daftar Corporate</span>
    ...
    const actionBodyTemplate = (rowData: TableData) => (
        <div className="flex justify-content-center gap-2">
            <Button
                ...
                onClick={() => {
                    formik.setValues({
                        kode_corporate: rowData.kode_corporate || '',
                        kode_cabang: rowData.kode_cabang || '',
                        name: rowData.name || '',
                        account_type: rowData.account_type || 'Corporate',
                        npwp: rowData.npwp || '',
                        billing_address: rowData.billing_address || '',
                        payment_term_days: rowData.payment_term_days || 0,
                        commission_pct: rowData.commission_pct || 0,
        ...
        <>
            <div className="card">
                <div className="flex justify-content-between align-items-start mb-4">
                    <div className="flex flex-column">
                        <h3 className="text-2xl font-semibold flex align-items-center gap-2">
                            <i className="pi pi-building text-blue-600 text-3xl"></i>Master Corporate / TA
                        </h3>
                        <p className="text-gray-500">Kelola informasi perusahaan (Corporate) dan Travel Agent (TA).</p>
                    </div>
                </div>
                ...
                <DataTable
                    ...
                    dataKey="kode_corporate"
                    emptyMessage="Tidak ada data corporate"
                ...
                >
                    ...
                    <Column field="kode_corporate" header="Kode" align="center" sortable style={{ minWidth: '10rem' }}></Column>
