            ...
            <Button
                ...
                onClick={() => {
                    formik.setValues({
                        ...
                        bisa_refund: rowData.bisa_refund || 0,
                        termasuk_sarapan: rowData.termasuk_sarapan || 0,
                        minimal_malam: rowData.minimal_malam || 1,
                        maksimal_malam: rowData.maksimal_malam || null,
