...
const Table = ({ dataRekap, setDataRekap, state, setState, formik, toast, getData, getPrintData, onLazyLoad }: TableProps) => {
    ...
    const headerTemplate = (
        <div className="flex flex-wrap align-items-center justify-content-between gap-2">
            <span className="text-xl font-bold">Daftar Fasilitas</span>
        ...
        <>
            <div className="card">
                <div className="flex justify-content-between items-start mb-6">
                    <div className="flex flex-column">
                        <h3 className="text-2xl font-semibold flex align-items-center gap-2">
                            <i className="pi pi-star text-blue-600 text-3xl"></i>Master Fasilitas
                        </h3>
                        <p className="text-gray-500">Kelola daftar fasilitas yang dapat diassign ke tipe kamar atau ruang event.</p>
                    </div>
                </div>
                ...
                <DataTable
                    ...
                    currentPageReportTemplate="Menampilkan {first} - {last} dari {totalRecords} data fasilitas"
                >
                    <Column selectionMode="multiple" headerStyle={{ width: '3rem' }} />
                    <Column field="is_active" header="" align="center" body={activeStatusBodyTemplate} style={{ minWidth: '4rem', width: '4rem' }}></Column>
                    <Column field="kode_fasilitas" header="Kode Fasilitas" align="center" sortable style={{ minWidth: '10rem' }}></Column>
