...
const Page = () => {
    ...
    const [dataRekap, setDataRekap] = useState<DataRekap>({
        ...
        show: false,
        adjust: false,
        fileName: `laporan-master-cashier_counter-${new Date().toISOString().slice(0, 10)}`,
        judul1: 'Laporan Master Cashier Counter',
        judul2: ''
    });
    ...
    const formik = useFormik<initValue>({
        ...
        validate: (data: initValue) => {
            ...
            if (!data.name || !data.name.trim()) errors.name = 'Nama Counter wajib diisi.';
            return errors;
        },
        onSubmit: (data) => {
