...
router.post("/", async (req, res) => {
  ...
  try {
    const baseQuery = DB("mst_tipe_kamar as rt").join("mst_cabang as h", "rt.kode_cabang", "h.kode_cabang").whereNull("rt.deleted_at").modify(qb => {
    ...
    const selectFields = ["rt.id","rt.kode_tipe_kamar","rt.kode_cabang","h.nama_hotel as cabang_name","rt.nama_tipe as name","rt.kapasitas_dasar","rt.kapasitas_maksimal","rt.luas_sqm as luas_m2","rt.deskripsi","rt.is_active","rt.created_at","rt.updated_at"];
