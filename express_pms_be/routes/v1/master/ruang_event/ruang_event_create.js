...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({ status: status.SUKSES, message: "Data Master Ruang Event berhasil dibuat", datetime: formatDateSystem(), data: { kode: cUniqueCode } });
  } catch (error) {
