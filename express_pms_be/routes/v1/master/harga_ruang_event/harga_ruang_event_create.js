...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    await DB.transaction(async (trx) => {
      ...
      const existingData = await trx("mst_harga_ruang_event")
        .where("kode_harga_ruang_event", cUniqueCode)
        .first();
      ...
      await ChangesLog(
        {
          description: "Tambah Master Harga Ruang Event",
    ...
    return res
      ...
      .json({
        ...
        message: "Data Master Harga Ruang Event berhasil dibuat",
        datetime: formatDateSystem(),
        data: { kode_harga_ruang_event: cUniqueCode },
      });
  } catch (error) {
    ...
    Logging(error, {
      file: "master/harga_ruang_event/harga_ruang_event_create.js",
      func: "create",
      request: oPayload,
      response: oResult,
      user: username,
