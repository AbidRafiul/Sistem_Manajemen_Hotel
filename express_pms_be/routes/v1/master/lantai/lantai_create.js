...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    await DB.transaction(async (trx) => {
      ...
      await ChangesLog(
        {
          description: "Tambah Master Lantai",
    ...
    return res
      ...
      .json({
        ...
        message: "Data Master Lantai berhasil dibuat",
        datetime: formatDateSystem(),
        data: { kode_lantai: cUniqueCode },
      });
  } catch (error) {
    ...
    Logging(error, {
      file: "master/lantai/lantai_create.js",
      func: "create",
      request: oPayload,
      response: oResult,
      user: username,
