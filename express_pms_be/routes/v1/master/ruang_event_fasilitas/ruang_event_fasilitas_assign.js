...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    await DB.transaction(async (trx) => {
      // Delete existing
      await trx("mst_ruang_event_fasilitas")
    ...
    return res
      ...
      .json({
        ...
        message: "Fasilitas berhasil disimpan ke Ruang Event",
    ...
    Logging(error, {
      file: "master/ruang_event_fasilitas/ruang_event_fasilitas_assign.js",
      func: "assign",
      request: oPayload,
      response: oResult,
      user: username,
