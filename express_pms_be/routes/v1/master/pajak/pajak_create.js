  ...
  try {
    ...
    const cValidation = await validatePayload(
      {
        ...
        is_compounding: Joi.number().valid(0, 1).optional().default(0).label("Compounding"),
    ...
    await DB.transaction(async (trx) => {
      ...
      const oData = {
        ...
        kode_pajak: cUniqueCode,
        name: oPayload.name,
        tax_type: oPayload.tax_type,
        percentage: oPayload.percentage,
        is_compounding: oPayload.is_compounding !== undefined ? oPayload.is_compounding : 0,
      ...
      await ChangesLog(
        {
          description: "Tambah Master Pajak",
          tableName: "mst_tax",
    ...
    return res
      ...
      .json({
        ...
        message: "Data Master Pajak berhasil dibuat",
        datetime: formatDateSystem(),
        data: { kode_pajak: cUniqueCode },
      });
  } catch (error) {
    ...
    Logging(error, {
      file: "master/pajak/pajak_create.js",
      func: "create",
      request: oPayload,
      response: oResult,
      user: username,
