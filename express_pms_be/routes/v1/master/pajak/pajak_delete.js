...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    await DB.transaction(async (trx) => {
      const records = await trx("mst_tax")
        .whereIn("kode_pajak", oPayload.kode_pajak)
      ...
      for (const r of records)
        await ChangesLog(
          {
            description: "Soft Delete Master Pajak",
            tableName: "mst_tax",
            referenceCode: r.kode_pajak,
            action: "DELETE",
            dataBefore: r,
    ...
    return res
      ...
      .json({
        ...
        message: "Data Master Pajak berhasil dihapus",
    ...
    Logging(error, {
      file: "master/pajak/pajak_delete.js",
      func: "delete",
      request: oPayload,
      response: oResult,
      user: username,
