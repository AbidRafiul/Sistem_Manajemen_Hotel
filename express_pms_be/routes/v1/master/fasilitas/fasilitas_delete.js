...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    await DB.transaction(async (trx) => {
      const records = await trx("mst_fasilitas")
        .whereIn("kode_fasilitas", oPayload.kode_fasilitas)
      ...
      for (const r of records)
        await ChangesLog(
          {
            description: "Soft Delete Master Fasilitas",
            tableName: "mst_fasilitas",
            referenceCode: r.kode_fasilitas,
            action: "DELETE",
            dataBefore: r,
    ...
    Logging(error, {
      file: "master/fasilitas/fasilitas_delete.js",
      func: "delete",
      request: oPayload,
      response: oResult,
      user: username,
