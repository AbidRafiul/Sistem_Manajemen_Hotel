...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    await DB.transaction(async (trx) => {
      const records = await trx("mst_tipe_ruang_event")
        .whereIn("kode_tipe_ruang_event", oPayload.kode_tipe_ruang_event)
      ...
      await trx("mst_tipe_ruang_event")
        .whereIn("kode_tipe_ruang_event", oPayload.kode_tipe_ruang_event)
        .update({
          is_active: 0,
      ...
      for (const r of records)
        await ChangesLog(
          {
            description: "Soft Delete Master Tipe Ruang Event",
            tableName: "mst_tipe_ruang_event",
            referenceCode: r.kode_tipe_ruang_event,
            action: "DELETE",
            dataBefore: r,
    ...
    Logging(error, {
      file: "master/tipe_ruang_event/tipe_ruang_event_delete.js",
      func: "delete",
      request: oPayload,
      response: oResult,
      user: username,
